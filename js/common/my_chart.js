    ...
    var fusioncharts = new FusionCharts({
        ...
        dataSource:{
                "chart": {
                    ...
                    "subcaption": data.company_name+"{br}Last 5days",
                    "numberPrefix": "INR ",
                    ...
                    //Visible data start and end index
                    "displayStartIndex": "49",
                    "displayEndIndex": "253",
                    "theme": "fint"
                },
                "categories": [{
                    "category": data.five_day.label
                }],
                "dataset": [
                    {
                        "data": data.five_day.value
                    }
                ]
            }
        });
...
function one_month()
{
    var fusioncharts = new FusionCharts({
        ...
        dataSource:{
                "chart": {
                    "caption": "Real-time stock price monitor",
                    "subcaption": data.company_name+"{br}Last 1 Months",
                    "numberPrefix": "INR ",
                    "yaxisname": "Stock Price",
                    "xaxisname": "Date",
                    "yaxisminValue": 7500,
                ...
                "categories": [{
                    "category": data.one_month.label
                }],
                "dataset": [
                    {
                        "data": data.one_month.value
                    }
                ]
            }
        });
...
function five_month()
{
    var fusioncharts = new FusionCharts({
        ...
        dataSource:{
                "chart": {
                    "caption": "Real-time stock price monitor",
                    "subcaption": data.company_name+"{br}Last 5 Months",
                    "numberPrefix": "INR ",
                    "yaxisname": "Stock Price",
                    "xaxisname": "Date",
                    "yaxisminvalue": 6800,
                ...
                "categories": [{
                    "category": data.five_month.label
...
function one_year()
{
    var fusioncharts = new FusionCharts({
        ...
        dataSource:{
                "chart": {
                    "caption": "Real-time stock price monitor",
                    "subcaption": data.company_name+"{br}Last 1 Year",
                    "yaxisname": "Stock Price",
                    "numberPrefix": "INR ",
                    "xaxisname": "Date",
                    "yaxisminValue": 6800,
                ...
                "categories": [{
                    "category": data.one_year.label
                }],
                "dataset": [
                    {
                        "data": data.one_year.value
                    }
                ]
            }
        });
